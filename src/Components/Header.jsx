...
const Header = () => {
  ...
  const handleLogout = () => {
    ...
    // You can also clear token from state if you have stored it in state
  ...
  return (
    <>
    <nav className=" bg-[#0ea5e9] w-full flex relative justify-between items-center mx-auto px-8 h-20">


    {/* <!-- logo --> */}
   <div className="inline-flex">
      <h1 className='font-bold text-3xl'>ProductInfo</h1>
</div>
